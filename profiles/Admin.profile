...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>Metric-Présentation de la métrique Réalisation</layout>
    ...
    <layoutAssignments>
        <layout>Objective__c-Pre%CC%81sentation Objectif</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Release__c-Project Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <pageAccesses>
        <apexPage>PROMISE_TaskList</apexPage>
